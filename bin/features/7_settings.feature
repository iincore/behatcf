...
#    Then I should see "Your settings have been saved."
  ...
  #
    ...
    Then I manually press "down" key on xpath "//*[@id='cf_studentbundle_locationstype_current_location']"
    Then I manually press "enter" key on xpath "//*[@id='cf_studentbundle_locationstype_current_location']"
    And I fill in "add-location" with "Mountain View, CA, United States "
    Then I manually press "down" key on xpath "//*[@id='add-location']"
    Then I manually press "enter" key on xpath "//*[@id='add-location']"
    And I look for the output wait "30" seconds
    Then I press "Save"
    And I look for the output wait "60" seconds
    Then I should see "Your settings have been saved."
